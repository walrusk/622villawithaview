...
<div class="page-menu">
	<ul>
		<li><i class="fa fa-map-o" aria-hidden="true"></i></li>
	</ul>
</div>
...
<section>
	...
	<p class="subtitle">It takes approximately 45 minutes to drive from East to West. Harbour Beach Villas is in the East End and if you look carefully you can see Secret Harbour Bay.</p>
